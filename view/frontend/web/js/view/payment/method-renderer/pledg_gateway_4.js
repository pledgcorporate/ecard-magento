...
define(
    ...
    function (
        ...
        return Component.extend({
            ...
            getTitle: function() {
                return window.checkoutConfig.payment.pledg_gateway_4.title;
            },

            getDescription: function() {
                return window.checkoutConfig.payment.pledg_gateway_4.description;
            },

            getPledgLogo:function(){
                var logo = window.checkoutConfig.payment.pledg_gateway_4.logo;

                return logo;
            },

            getMerchantUid:function(){
                var merchant_uid = window.checkoutConfig.payment.pledg_gateway_4.merchant_uid;

                return merchant_uid;
            },

            getAllowedCountries: function() {
                return window.checkoutConfig.payment.pledg_gateway_4.allowed_countries;
            },
