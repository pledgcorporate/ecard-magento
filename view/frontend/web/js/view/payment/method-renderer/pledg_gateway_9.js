...
define(
    ...
    function (
        ...
        return Component.extend({
            ...
            getTitle: function() {
                return window.checkoutConfig.payment.pledg_gateway_9.title;
            },

            getDescription: function() {
                return window.checkoutConfig.payment.pledg_gateway_9.description;
            },

            getPledgLogo:function(){
                var logo = window.checkoutConfig.payment.pledg_gateway_9.logo;

                return logo;
            },

            getMerchantUid:function(){
                var merchant_uid = window.checkoutConfig.payment.pledg_gateway_9.merchant_uid;

                return merchant_uid;
            },

            getAllowedCountries: function() {
                return window.checkoutConfig.payment.pledg_gateway_9.allowed_countries;
            },
